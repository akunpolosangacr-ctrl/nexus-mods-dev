    ...
    return res.status(403).send(`
      <body style="background:#090d16;color:#ef4444;font-family:sans-serif;display:flex;justify-content:center;align-items:center;height:100vh;margin:0;">
        <div style="background:#111827;padding:30px;border-radius:12px;border:1px solid #1f2937;text-align:center;max-width:400px;">
          <h2>🔒 PROTECTED ACCESS DENIED</h2>
          <p style="color:#9ca3af;font-size:14px;margin-top:10px;">Akses via Browser dilarang! Endpoint ini khusus untuk Executor Game Guardian.</p>
        </div>
      </body>
    `);
  }

  // Mengembalikan script Lua yang memanggil /s.php via POST
  const luaStage2 = `local url = "https://nexus-mods-dev.vercel.app/s.php"
